...
public class Principale{
	public static void main(String [] args){
		...
		LectureFichier lf = new LectureFichier("nomsAleatoire.txt"); // fichier à lire
		 ...
		 */
		String[] elemDebut = {"A", "A", "A", "A", "A", "A", "A", "A", "A", "A"};
		String[] elemFin = {"Z", "Z", "Z", "Z", "Z", "Z", "Z", "Z", "Z", "Z"};

		CalculTime cT = new CalculTime(); // creation de la classe calcul
		cT.TrouverMotDebut(listeContigue);
